...
function Sepet() {
  ...
  useEffect(() => {
    const url = "/basket/?userId=" + currentUser;
    ...
    > 
     ...
     <h5 className="card-title">{product.name}</h5>
          ...
          <div className="card-body">
            <b className="card-text">Durum: {product.state} </b><hr></hr>
            <b className="card-text">Kategori: {product.category} </b>
            <hr></hr>
          </div>
          ...
          >
            {localStorage.getItem("currentUser") == null ? (
              ...
              <div className="input-group mb-3" style={{ marginBottom: "1px" }}>
                <div> 
                  <button className= "btn btn-outline-warning btn-danger" style={{marginLeft: '100px', color: 'white'}} >Satın Al</button>                  
                   </div>
